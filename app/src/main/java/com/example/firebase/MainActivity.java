...
public class MainActivity extends AppCompatActivity {
    ...
    public void enviarDatosFirestore(View view) {
        ...
        db.collection("Firebase").document(codigo).set(mascota).addOnSuccessListener(aVoid -> {
    ...
    public void CargarListaFirestore() {
        ...
        db.collection("Firebase").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
